...
install-oh-my()
{
    ...
    if [ "${OH_MY}" = "bash" ]; then
        sed -i -e 's/OSH_THEME=.*/OSH_THEME="robbyrussell"/g' ${USER_RC_FILE}
        mkdir -p ${OH_MY_INSTALL_DIR}/custom/themes/robbyrussell
        echo "${CODESPACES_BASH}" > ${OH_MY_INSTALL_DIR}/custom/themes/robbyrussell/robbyrussell.theme.sh
    else
        sed -i -e 's/ZSH_THEME=.*/ZSH_THEME="robbyrussell"/g' ${USER_RC_FILE}
        mkdir -p ${OH_MY_INSTALL_DIR}/custom/themes
        echo "${CODESPACES_ZSH}" > ${OH_MY_INSTALL_DIR}/custom/themes/robbyrussell.zsh-theme
    fi
